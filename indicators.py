...
class Ui_Form_Ind(object):
    ...
    def setupUi(self, Form):
        ...
        self.ind_input_line.setGeometry(QtCore.QRect(350, 10, 501, 41))
        ...
        self.add_new_ind_ok.setGeometry(QtCore.QRect(860, 10, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.add_new_ind_no.setGeometry(QtCore.QRect(970, 10, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
